...
{
    public function __construct(protected TelegramMessageService $telegramMessageService, protected  ClientsService $clientsService) {}
    ...
    public function handle(int $clientBotId, int|string $chatId, int $messageId): void
    {
        ...
        $this->telegramMessageService->sendMessageWithButtons($chatId, __('messages.get_country'), $keyboard, $messageId);
