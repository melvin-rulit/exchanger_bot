...
<!--       </div>-->
        ...
        <table class="w-full whitespace-nowrap">
            ...
            <tbody>
            <tr v-for="order of orders" tabindex="0" @click="showModalOrderDetail(order, order.user)" class="inside_table h-12 hover:bg-gray-100">
                <td v-if="order.is_message" class="pl-4">
                ...
                <td class="pl-2">
                    <div class="flex items-center">
                        <span :class="getStatusColor(order.status)" class="text-base font-medium leading-none mr-2">{{ translateStatus(order.status) }}</span>
                    </div>
                </td>
              <td class="">
                <div class="flex items-center">
  ...
  {{order.client.first_name}}
              ...
              <td class="">
                ...
                <td class="pl-5">
                    <div class="flex items-center">
                        <img @click="showModal(order.media[0]['original_url'])" :src="order.media[0]['original_url']" class="h-8 w-8 object-cover rounded cursor-pointer"  alt=""/>
                    </div>
                </td>
