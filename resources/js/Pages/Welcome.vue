...
<template>
    <Head title="Welcome" />
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50" style="background-image: url('Images/background.jpg')">
<!--        <img-->
<!--            id="background"-->
<!--            class=""-->
...
<!--                        </svg>-->
                    ...
                    <nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end">
                        <Link
                            ...
                            class="rounded-md px-3 py-2 text-white text-lg ring-1 ring-transparent transition hover:underline focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                        >
                            Dashboard
                        </Link>
